...
void EmptyLinkFunctionForGeneratedCodeCryptRaider_init() {}
	...
	FORCENOINLINE UPackage* Z_Construct_UPackage__Script_CryptRaider()
	{
		if (!Z_Registration_Info_UPackage__Script_CryptRaider.OuterSingleton)
		{
			static UObject* (*const SingletonFuncArray[])() = {
				(UObject* (*)())Z_Construct_UDelegateFunction_CryptRaider_OnItemUsed__DelegateSignature,
			};
	...
	static FRegisterCompiledInInfo Z_CompiledInDeferPackage_UPackage__Script_CryptRaider(Z_Construct_UPackage__Script_CryptRaider, TEXT("/Script/CryptRaider"), Z_Registration_Info_UPackage__Script_CryptRaider, CONSTRUCT_RELOAD_VERSION_INFO(FPackageReloadVersionInfo, 0xDE788749, 0x65154857));
